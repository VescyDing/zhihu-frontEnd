...
<script>
  ...
  export default {
    ...
    data () {
      return {
        colorList: ['#ffcf00','#43d480','#0084ff','#0f88eb','#5478f0']
      };
    },
