<template>
    <div>
        <div style="width: 120%;transform: translateX(-8%)">
            <div class="QuestionHeader">
                ...
                <div style="width: 1000px;margin: 0 auto;position: relative">
                    <div class="QuestionHeader-main">
                        ...
                        <button aria-label="更多" type="button" id="Popover7-toggle" aria-haspopup="true" aria-expanded="false" aria-owns="Popover7-content" class="Button Button--plain Button--withIcon Button--iconOnly"><span style="display: inline-flex; align-items: center;">​<svg class="Zi Zi--Dots Button-zi" fill="currentColor" viewBox="0 0 24 24" width="1.2em" height="1.2em"><path d="M5 14a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm7 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm7 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" fill-rule="evenodd"></path></svg></span></button>
                    </div>
        ...
        <div class="Question-main">
            <div class="Question-mainColumn">
                ...
                <div class="AnswerCard Block">
                    ...
                    <div style="color: #666666;margin: 10px auto">
                        绝大部分前端都是自学成才的。我面试过的大部分校招生都是普通大学的，非 985 211。其中有不少也很优秀。四年后，光会前端可能不足够你找工作了。前端只是软件工程上薄薄的一层皮。把计算机基础打好，算法，网络，数据结构，数学，图形学，统计学（嗯，我把后两门专门从数学中单拎出来），这些才是真正恒久远的知识。别听楼上的一些追各种框架，各种面试经。
                    </div>
                    <div class="Button" style="padding: 0;margin-left: 0">
                       编辑于2020年3月26日
                    </div>
                    <div class="ContentItem-actions">
                        <el-button style="color: #0084ff;background: rgba(0,132,255,.1);border: 0" size="mini" type="primary" @click="" icon="el-icon-caret-top">赞同 999</el-button>
                        <el-button style="margin-right: 40px;color: #0084ff;background: rgba(0,132,255,.1);border: 0" size="mini"  type="primary" @click="" icon="el-icon-caret-bottom"></el-button>
                        <el-button size="mini"style="font-size: 14px;color: #8590a6" type="text" icon="el-icon-chat-dot-round">666 条评论</el-button>
                        <el-button size="mini"style="font-size: 14px;color: #8590a6" type="text" icon="el-icon-share">分享</el-button>
                        <el-button size="mini"style="font-size: 14px;color: #8590a6" type="text" icon="el-icon-star-off">收藏</el-button>
                        <el-button size="mini"style="font-size: 14px;color: #8590a6" type="text" icon="el-icon-s-flag">喜欢</el-button>
                    </div>
                </div>
            </div>
